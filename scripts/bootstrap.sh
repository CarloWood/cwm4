...
aclocal_version=`$ACLOCAL --version | head -n 1 | sed -e 's/[^12]*\([12]\.[0-9][^ ]*\).*/\1/'`
...
echo "dnl This file is automatically generated, do not edit. Edit autogen_versions instead." > min_automake_version.m4
echo "$required_automake_version dnl" >> min_automake_version.m4
echo "dnl This file is automatically generated, do not edit. Edit autogen_versions instead." > min_autoconf_version.m4
echo "$required_autoconf_version dnl" >> min_autoconf_version.m4
